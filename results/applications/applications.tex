\chapter{Applications}
    ...
    \section{Spin-dependent laser pulses}
        ...
        In \autoref{fig:isborn-h2} we have plotted the absorption spectra of
        ...
        the dashed lines in \autoref{fig:isborn-h2}.
        ...
        In \autoref{tab:h2-sto-3g-isborn-transitions} we've listed all allowed
        dipole transitions in the STO-3G basis for \ch{H2}.
        ...
        \begin{table}
            \centering
            \caption{Dipole allowed transitions for \ch{H2} in the STO-3G basis
            computed using CISD.
            ...
            \begin{tabular}{@{}llll@{}}
                \toprule
                Transition & Singlet allowed
                & $\Delta \energy$ $[\si{\hartree}]$
                & $\Delta \energy$ $[\si{\electronvolt}]$ \\
                \midrule
                $0 \to 1$ & no & $0.6065$ & $16.5040$ \\
                $0 \to 3$ & no & $0.6065$ & $16.5040$ \\
                $0 \to 4$ & yes & $0.9689$ & $26.3660$ \\
                \bottomrule
            \end{tabular}
            \label{tab:h2-sto-3g-isborn-transitions}
        \end{table}
        From \autoref{tab:h2-sto-3g-isborn-transitions} we see that the
        degenerate transitions $0 \to 1$ and $0 \to 3$ are triplet-only allowed
        transitions, but the interesting thing is that the transition $0 \to 2$
        is also a transition with the same energy level.
        However, the latter transition is \emph{not} a dipole-allowed triplet
        transition.
        In \autoref{tab:h2-6-31gss-isborn-transitions} we've included the dipole
        allowed transitions for \ch{H2} in the 6-31G** basis.
        \begin{table}
            \centering
            \caption{Dipole allowed transitions for \ch{H2} in the 6-31G** basis
            computed using CISD.
            The interpretation of the columns is the same as in
            \autoref{tab:h2-sto-3g-isborn-transitions}.
            We've limited the energy levels to $\Delta \energy \leq
            \SI{1}{\hartree}$ to avoid too much clutter.}
            \begin{tabular}{@{}llll@{}}
                \toprule
                Transition & Singlet allowed
                & $\Delta \energy$ $[\si{\hartree}]$
                & $\Delta \energy$ $[\si{\electronvolt}]$ \\
                \midrule
                $0 \to 1$ & no & $0.4020$ & $10.9403$ \\
                $0 \to 2$ & no & $0.4020$ & $10.9403$ \\
                $0 \to 3$ & no & $0.4020$ & $10.9403$ \\
                $0 \to 4$ & yes & $0.5523$ & $15.0277$ \\
                \bottomrule
            \end{tabular}
            \label{tab:h2-6-31gss-isborn-transitions}
        \end{table}
        % TODO: Add peaks from Fourier specter
        ...
        \begin{figure}
            ...
            spin-functions.
            No extra label means that the field is spin-indepdenent.}
            \label{fig:isborn-lih}
        \end{figure}

        \begin{table}
            \centering
            \caption{Dipole allowed transitions for \ch{LiH} in the STO-3G basis
            computed using CISD.
            ...
            \begin{tabular}{@{}llll@{}}
                ...
                & $\Delta \energy$ $[\si{\electronvolt}]$ \\
                \midrule
                $0 \to 1$ & no & $0.1138$ & $3.0959$ \\
                $0 \to 2$ & no & $0.1138$ & $3.0959$ \\
                $0 \to 3$ & no & $0.1138$ & $3.0959$ \\
                $0 \to 4$ & yes & $0.1313$ & $3.5741$ \\
                $0 \to 13$ & no & $0.3891$ & $10.5879$ \\
                $0 \to 14$ & no & $0.3891$ & $10.5879$ \\
                $0 \to 15$ & no & $0.3891$ & $10.5879$ \\
                \bottomrule
            \end{tabular}
            \label{tab:lih-sto-3g-isborn-transitions}
        \end{table}

        \begin{table}
            \centering
            \caption{Dipole allowed transitions for \ch{LiH} in the 6-31G**
            basis computed using CISD.
            We only include results for $\Delta \energy \leq
            \SI{0.5}{\hartree}$.}
            \begin{tabular}{@{}llll@{}}
                \toprule
                ...
                & $\Delta \energy$ $[\si{\electronvolt}]$ \\
                \midrule
                $0 \to 1$ & no & $0.1099$ & $2.9894$ \\
                $0 \to 2$ & no & $0.1099$ & $2.9894$ \\
                $0 \to 3$ & no & $0.1099$ & $2.9894$ \\
                $0 \to 4$ & yes & $0.1259$ & $3.4261$ \\
                $0 \to 13$ & no & $0.2222$ & $6.0468$ \\
                $0 \to 14$ & no & $0.2222$ & $6.0468$ \\
                $0 \to 15$ & no & $0.2222$ & $6.0468$ \\
                $0 \to 16$ & yes & $0.2639$ & $7.1813$ \\
                $0 \to 25$ & no & $0.3098$ & $8.4313$ \\
                $0 \to 26$ & no & $0.3098$ & $8.4313$ \\
                $0 \to 27$ & no & $0.3098$ & $8.4313$ \\
                $0 \to 28$ & yes & $0.3109$ & $8.4591$ \\
                $0 \to 29$ & no & $0.3410$ & $9.2796$ \\
                $0 \to 30$ & no & $0.3410$ & $9.2796$ \\
                $0 \to 31$ & no & $0.3410$ & $9.2796$ \\
                $0 \to 32$ & yes & $0.4127$ & $11.2290$ \\
                \bottomrule
            \end{tabular}
            \label{tab:lih-6-31gss-isborn-transitions}
        \end{table}
        % TODO: Add peaks from Fourier specter
