\chapter{Applications}
    ...
    \section{Spectra of noble gasses}
        ...
        decimal places for \ch{Ne} in the aug-cc-pVDZ basis.
    ...
    \section{Spin-dependent laser pulses}
        ...
        % TODO: Find out about resolution of FFT!
        ...
        project.
        % TODO: Discuss the spin-mixing-thingy?
    ...
    \section{Ionization of one-dimensional atoms}
        ...
        Note that \citeauthor{miyagi_and_madsen} uses a
        ...
        Using the same definition as \citeauthor{takeshi}, we define
        ionization as all components outside a radius of $\SI{20}{\bohr}$ from
        the center of the nucleus \cite{takeshi}.
        ...
        We see that this basis does not allow any
        where a basis of $L = 20$
        spin-orbitals, that is, $L / 2 = 10$ orbitals, has been used.
