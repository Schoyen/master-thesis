\chapter{Quantum dots}
    ...
    \section{Ground state energies}
        \begin{table}
            ...
            energies for $N$ two-dimensional quantum dots.
            ...
            \begin{tabular}{cc}
                \begin{tikzpicture}
                    ...
                    \begin{polaraxis}[
                        ...
                        table
                        {results/quantum-dots/two-dim-quantum-dots/one-body-densities/dat/oaccd_n=2_l=72_omega=1.0_rho_real.dat};
                    \end{polaraxis}
                \end{tikzpicture}
                &
                \begin{tikzpicture}
                    ...
                    \begin{polaraxis}[
                        ...
                        table
                        {results/quantum-dots/two-dim-quantum-dots/one-body-densities/dat/oaccd_n=6_l=72_omega=1.0_rho_real.dat};
                    \end{polaraxis}
                \end{tikzpicture}
            \end{tabular}
            \caption{Bleh}
            \label{fig:densities-tdho-2-6}
        \end{figure}
