...
from isborn_system import get_h2_system, get_lih_system

from configuration_interaction import CISD, CIS

h2_no = get_lih_system(spin_dependent=False, basis="6-31gss")
h2_yes = get_lih_system(spin_dependent=True, basis="6-31gss")
...
for J in range(1, len(cisd_no.energies)):
    if cisd_no.energies[J] - cisd_no.energies[0] > 0.5:
        break
