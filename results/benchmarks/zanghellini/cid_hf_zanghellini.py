...
hf.compute_ground_state(change_system_basis=True, tol=1e-5)
...
write_data(
    os.path.join(path, "rho_tdcid_hf_real.dat"), odho.grid, rho_tdcid.real
)
...
write_data(
    os.path.join(path, "overlap_tdcid_hf_real.dat"),
