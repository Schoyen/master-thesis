\chapter{Benchmarking against litterature}
    ...
    \section{Atoms and molecules}
        ...
        \subsection{Electronic spectra of molecules}
            ...
            \begin{figure}
                ...
                \begin{tikzpicture}
                    ...
                    \end{axis}
                \end{tikzpicture}
                \caption{In this figure we show the Fourier transform of the
                dipole moment in $z$-direction using time-dependent
                Hartree-Fock, time-dependent coupled cluster with singles and
                doubles, orbital-adaptive time-dependent coupled cluster with
                doubles excitations.}
                \label{fig:fft_dipole_z_nest}
            \end{figure}
            % TODO: Discuss sampling of the dipole moment and taking the Fourier
            % transform in order to find the enegy spectra.
            % TODO: Add plot of laser field.
