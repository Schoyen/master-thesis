\chapter{Coupled cluster theory}
    ...
    \section{Time-independent coupled cluster theory}
        ...
        \subsection{The coupled cluster Lagrangian}
            ...
            \end{align}
            where we've denoted the coupled cluster wave functions by
            \begin{gather}
            ...
            have that $\tr{\density} = 1$ and $\density^2 = \density$, but
            $\density \neq \density^{\dagger}$ \cite{kvaal2013variational}.
            We can thus describe the coupled cluster wave function as a
            non-Hermitian, pure state \cite{kvaal2013variational}.
