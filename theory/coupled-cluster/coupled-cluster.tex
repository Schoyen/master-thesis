\chapter{Coupled-cluster theory}
    ...
    \section{Time-independent coupled-cluster theory}
        ...
        \subsection{The coupled-cluster Lagrangian}
            ...
            \end{align}
            where we have introduced the relaxation operator $\clustl$ from the
    ...
    \section{Time-dependent coupled-cluster theory}
        ...
        \end{align}
        The former equation yields the time evolution of the
        $\clustamp_{\mu}$-amplitudes whereas the latter yield the time evolution
        for the $\clustlamp_{\mu}$-amplitudes.
    ...
    \section{Orbital-adaptive formulation}
        \label{sec:oatdcc}
        ...
        \subsection{$P$-space equations}
            ...
            \begin{gather}
                ...
                A^{ja}_{bi},
            \end{gather}
            where we have defined the coefficient matrix $\vfg{A}$.
        ...
        \subsection{$Q$-space equations}
            ...
            \end{align}
            where we have written out the explicit orbital dependencies in the
    ...
    \section{The quality of the reference state in time}
        \label{sec:cc-phase}
        ...
        conserved,\footnote{%
           When the time-dependence in the Hamiltonian is turned off.
        } and the data produced can no longer be trusted
