\chapter{Coupled cluster theory}
    ...
    \section{Time-dependent coupled cluster theory}
        ...
        \subsection{Orbital-adaptive time-dependent coupled-cluster theory}
            ...
            orbital rotations along with the coupled-cluster amplitudes $\clust$
            and $\clustl$, with the orbitals subject to the constraint that they
            are biorthogonal, that is,
            \begin{align}
                \braket*{\tilde{\phi}_p}{\phi_q} = \delta_{pq},
            \end{align}
            where we denote the bra states by tilde to distinguish it from the
            adjoint state.
            In general we have $\ket{\phi_p}^{\dagger} \neq
            \bra*{\tilde{\phi}_p}$ as the two orbitals are defined in two
