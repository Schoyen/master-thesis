\chapter{Quantum mechanics}
    ...
    \section{Electrodynamics}
        ...
        \subsection{The dipole approximation}
            ...
            \end{align}
            Inserted into the particle-field interaction term of the Hamiltonian
            we find
            \begin{align}
                \hamil_{ep}
                = -\frac{q}{m}\vfg{A}\cdot\momentumvec
                = -\frac{q}{m}\vfg{\epsilon}\cdot\momentumvec
                \brak{
                    A_0 e^{-i\omega_k t}
                    + A^{*}_0 e^{i\omega_k t}
                }.
            ...
            part related to the negative frequency solutions and a absorption
            ...
            \begin{gather}
                2\Re(A_0) = \mathcal{E}_0\cos(\phi), \\
                2\Im(A_0) = -\mathcal{E}_0\sin(\phi),
            \end{gather}
