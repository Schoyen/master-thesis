\chapter{Quantum mechanics}
    ...
    \section{The time-dependent variational principle}
        ...
        \begin{proof}
            ...
            Letting $\delta\psi(x, t)$ be arbitrary variations we recover the
        ...
        \end{proof}
        We shall see that with the help of the action functional, the
        introduction of a time-dependent coupled cluster theory with states that
        are not Hermitian conjugate of each other becomes more natural.
