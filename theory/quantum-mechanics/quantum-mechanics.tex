\chapter{Quantum mechanics}
    ...
    In the following chapters we move on to more specialized theories that will
    utilize many of the results from this chapter.
    ...
    \section{Time-independent Schrödinger equation}
        ...
        operator and we have included the external potential $\hat{v}(\vfg{r},
        t)$.
        ...
        find the \emph{time-independent Schrödinger equation},
        \begin{align}
    ...
    \section{The variational principle}
        ...
        \begin{proof}
            ...
            \cite{kvaal2017notes}, we can write the derivatives of the energy
            functionals, and hence the stationary conditions to be
            \begin{gather}
                \left.
                \dpd{E[\tilde{\psi}, \psi^{*}]}{\epsilon}
                \right\rvert_{\epsilon = 0}
        ...
        \subsection{The variational method}
            ...
            \end{align}
            where we have introduced the normalization condition for the trial
            ...
            \end{gather}
            where we have defined the overlap matrix $\overlapmat$ from the
            ...
            See the book \citetitle{helgaker-molecular} by
    ...
    \section{The time-dependent Schrödinger equation}
        ...
        \begin{align}
            ...
            \label{eq:tdse}
        \end{align}
        Given an initial state $\ket*{\psi(t_0)}$ at an initial time $t_0$, we
        can use the time-dependent Schrödinger equation to determine
        $\ket*{\psi(t)}$ for all earlier and later times.
    ...
    \section{The time evolution operators}
        ...
        \end{align}
        where we have absorbed the time-dependency into the coefficients, and
        ...
        All observables that commute with the time-independent Hamiltonian will
        still be time-independent for $\ket*{\psi(t)}$.
    ...
    \section{Electrodynamics}
        ...
        \subsection{Particle-field interactions}
            ...
            \end{align}
            where we have denoted the particle (or, matter) contribution by
            ...
            \begin{align}
                ...
                + v(\vfg{r}),
            \end{align}
            where we have ignored particle-particle interaction in this
            discussion.
        ...
        \subsection{The dipole approximation}
            ...
            \end{align}
            where $\phi$ is a phase factor and we have defined
            \begin{gather}
            ...
            \end{gather}
            where we have inserted the electric field $-\vfg{E} = \dot{\vfg{A}}$
    ...
    \section{Laser fields}
        ...
        pulse and we will discuss it in due time.
        ...
        \subsection{Envelope}
            ...
            \begin{figure}
                ...
                the envelope) on a grid with $t \in [-30, 30]$ in dimensionless
                units.
        ...
        \subsection{Measuring energy transitions}
            ...
            \subsubsection{Autocorrelation}
                ...
                \end{align}
                where we have used that the eigenstates of the time-independent
            ...
            \subsubsection{Dipole moment}
                ...
                moment, but we have kept the vector notation to demonstrate that
