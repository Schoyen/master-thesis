\chapter{Quantum mechanics}
    ...
    \section{Electrodynamics}
        ...
        \subsection{Electromagnetic field and particle interactions}
            ...
            Note that as we work in the Coulomb gauge without sources, we have
            set $\phi = 0$.
            In the case of a scalar potential, the expression for $\hamil_{f}$
            needs to include a term $q\phi$.
            ...
            As we are treating the electromagnetic field in a perturbative
            manner we will ignore the second term in \autoref{eq:hamil-ep} as it
            is quadratic in the field and will therefore be much smaller than
            the first term in the particle-field interaction.
