\chapter{Quantum mechanics}
    ...
    \section{Laser fields}
        ...
        \subsection{Envelope}
            ...
            Common choices are sine-squared, Gaussian, and the hyperbolic secant
            functions.
            The functions for $t \in [t_0, T]$ can then be expressed
            \begin{gather}
                F(t) = \begin{cases}
                    \sin^2\brak{
                        \frac{\pi (t - t_0)}{T}
                ...
                F(t) = \exp[
                    -\frac{\pi^2(t - t_0)^2}{2T^2}
                ],
            \end{gather}
            where $t_0$ is the start of the laser pulse and $T$ the end of the
            pulse.
            Note that only the sine-squared envelope requires a manual stopping
            of the pulse as the function is periodic.
