\chapter{Many-body quantum mechanics}
    ...
    \section{Wick's theorem}
        ...
        operators on normal-ordered form, that is, $\hat{A} = \brac{\hat{A}}$,
        we will then have
        \begin{align}
            \brac{\hat{A}}\ket{\vac} = 0,
        \end{align}
        ...
        \begin{definition}
            ...
            \begin{align}
                ...
                - \brac{\hat{A}\hat{B}},
            \end{align}
            where $\brac{\hat{A}\hat{B}}$ is the normal-ordered form of the
            operator pair $\hat{A}\hat{B}$.
        \end{definition}
