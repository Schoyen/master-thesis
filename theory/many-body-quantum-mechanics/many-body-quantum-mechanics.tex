    ...
    \section{Slater determinants}
        ...
        \subsection{Fermi vacuum}
            ...
            \begin{align}
                ...
                = \acom{\ccr{a}}{\can{i}}
                = 0,
                \label{eq:fermi-anticommutation}
            \end{align}
        ...
        \subsection{Excited determinants}
            ...
            \autoref{eq:fermi-anticommutation} we see that
            \begin{align}
            ...
            \subsubsection{Overlap with the reference state}
                If the basis of single-particle states are orthonormal, then
