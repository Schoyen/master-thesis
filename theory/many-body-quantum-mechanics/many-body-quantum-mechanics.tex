    ...
    \section{Spin-orbitals}
        ...
        \subsection{Basis transformations}
            ...
            \begin{proof}
                ...
                \begin{align}
                    \ket{\phi_p} = U_{p\mu}\ket{\xi_{\mu}},
                \end{align}
                where $U_{p\mu}$ is an element in the unitary matrix $\vfg{U}
                \in \mathbb{C}^{L \times L}$.
                As the atomic orbitals are orthonormal, we find
                \begin{align}
                    \braket{\phi_{p}}{\phi_{q}}
                    =
                    U^{*}_{p \mu} \braket{\xi_{\mu}}{\xi_{\nu}}
                    U_{q\nu}
                    = U^{*}_{p\mu} U_{q\mu}
                    = \delta_{pq},
                \end{align}
    ...
    \section{Slater determinants}
        ...
        \subsection{Orbital rotations}
            ...
            \begin{lemma}
                ...
                $\ket{\slat}$.
                This unitary transformation will preserve the normalization of
                the original Slater determinant.
            \end{lemma}
            \begin{proof}
            ...
            % TODO: Connect these two sections.
