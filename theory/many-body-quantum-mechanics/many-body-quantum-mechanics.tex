\chapter{Many-body quantum mechanics}
    ...
    \section{Second quantization}
        ...
        Moving to second quantization we will express wave functions as field
        operators working on the vacuum state.
        These operators provide a way to express many-body wave
        functions\footnote{%
            Or more precisely, configurations of many-body wave functions.%
        } as a product of field operators where each field represents a
        particle.
        ...
        \subsection{Field operators}
            ...
            particle states.\footnote{Also known as \emph{fields}.}
            ...
            This sign change is also another way to invoke the Pauli exclusion
            principle as can be seen by considering a state $\ket{1_1} \in
            F_{-}(L, 1)$ and acting with $\ccr{1}$, viz.
            \begin{align}
                \ccr{1}\ket{1_1}
                = \ket{1_1, 1_1}
                = -\ket{1_1, 1_1}
                = 0,
            \end{align}
            where we interchange the two particles to incur a sign change.
            We have for the sake of argument ignored that a fermionic Fock state
            $\ket{2_1} = 0$, by construction.
            This means that
            \begin{align}
                \ccr{p}\ccr{p} = 0,
            \end{align}
            ...
            \end{gather}
            which yields the expected sign change.
            ...
            \end{definition}
            From the definition of the field operator we have that
            \begin{align}
                \can{p}\can{p} = 0,
            \end{align}
            ...
            \end{align}
            This can be seen by taking the Hermitian conjugate of the
