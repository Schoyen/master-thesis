\chapter{Many-body quantum mechanics}
    ...
    \section{The many-body Hamiltonian}
        ...
        \subsection{One-body Hamiltonian}
            ...
            The potential term can come from many different sources, e.g.,
            external field, mean-field approximation, electron-nucleon
            interaction, etc, and we will discsuss these more in depth when we
            start looking at specific systems.
