\chapter{Many-body quantum mechanics}
    ...
    \section{Spin-orbitals}
        ...
        underlying basis.
        Since we're exploring systems of fermions, we will limit our attention to
        ...
        $\beta(m_s)$ and we have denoted the spatial orbital by $\phi(\vf{r})$.
    ...
    \section{The multireference problem}
        ...
        regime.
        As an example, consider the lithium (\ch{Li}) atom with three electrons, thus
        requiring a fourth electron in order to get a closed shell.
        In the case of a non-interacting \ch{Li} atom in a given spin-orbital
