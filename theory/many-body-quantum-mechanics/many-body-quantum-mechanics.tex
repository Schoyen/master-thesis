    ...
    \section{Particle statistics}
        ...
        \begin{align}
            ...
            = p_{ik} \psi(\vf{x})
             = p_{jk} \psi(\vf{x}),
        \end{align}
        which tells us that the eigenvalues of any exchange operator is the
        same.
        This means that the eigenvalue is a charateristic of the wave function
        $\psi(\vf{x})$.
        ...
        \begin{figure}
            ...
            \begin{tikzpicture}
                \begin{scope}
                    \draw (-4, 0) node[anchor=east] {$(i, j, k)$} -- (4, 0);
                ...
                \begin{scope}[yshift=-2cm]
                    \draw (-4, 0) node[anchor=east] {$(k, j, i)$} -- (4, 0);
                    \draw[black, thick, fill=magenta] (-3, 0) circle (0.25cm);
                    \draw[black, thick, fill=blue] (0, 0) circle (0.25cm);
                    \draw[black, thick, fill=red] (3, 0) circle (0.25cm);
                \end{scope}
                \begin{scope}[yshift=-4cm]
                    \draw (-4, 0) node[anchor=east] {$(j, k, i)$} -- (4, 0);
                    \draw[black, thick, fill=blue] (-3, 0) circle (0.25cm);
                    \draw[black, thick, fill=magenta] (0, 0) circle (0.25cm);
                    \draw[black, thick, fill=red] (3, 0) circle (0.25cm);
                \end{scope}
                \begin{scope}[yshift=-6cm]
                    \draw (-4, 0) node[anchor=east] {$(i, k, j)$} -- (4, 0);
                    \draw[black, thick, fill=red] (-3, 0) circle (0.25cm);
                    \draw[black, thick, fill=magenta] (0, 0) circle (0.25cm);
                    \draw[black, thick, fill=blue] (3, 0) circle (0.25cm);
                \end{scope}
            \end{tikzpicture}
            \caption{In this figure we illustrate how a single transposition
        ...
        We define the \emph{exchange operator} $\hat{P}_{ij}$ as the
