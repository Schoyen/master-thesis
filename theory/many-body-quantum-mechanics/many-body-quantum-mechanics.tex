\chapter{Many-body quantum mechanics}
    ...
    \section{Slater determinants}
        ...
        \subsection{Basis transformation}
            % TODO: Discuss how a basis transformation of single-particle states
            % reflects on the Slater determinants.
            \begin{lemma}
    ...
    \section{Many-body density matrices}
        ...
        \subsection{One-body density matrix}
            ...
            \subsubsection{Particle density}
                ...
                under the influence of all the other particles.
    ...
    \section{The multireference problem}
        ...
        assumption and will often be more challenging to solve numerically if
        the initial reference state is degenerate.
