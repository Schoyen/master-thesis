...
\section{Two-dimensional quantum dot}
    ...
    \subsection{Two-dimensional harmonic oscillator}
        ...
        where we have
        \begin{align}
            \lambda \equiv \frac{e^2}{4\pi \epsilon_0 a_0}.
        ...
        \begin{align}
            \hamilten(\vfg{r})
            = \frac{\omega}{2} \sum_{i = 1}^{N}\brak{
                -\vfg{\nabla}^2_i
                + \vfg{r}^2_i
            }
            + \sqrt{\omega} \sum_{i < j}^{N} \frac{1}{\abs{\vfg{r}_i -
            \vfg{r}_j}},
        \end{align}
        ...
        \begin{align}
            ...
            \rho(r),
        \end{align}
        where $\rho(r)$ is a function of $r$ and $a$ is the Bohr radius.
        % TODO: This is the inverse of the Bohr radius!!!!
