\chapter{Hartree-Fock theory}
    ...
    \section{Solving the Hartree-Fock equations in a basis}
        ...
        \subsection{Hartree-Fock with general spin-orbitals}
            ...
            $\brac{\ket{\chi_{\alpha}}}_{\alpha = 1}^{L}$ we wish to find an
            ...
            \end{align}
            where $\vfg{C} \in \mathbb{C}^{L\times L}$ is now our unknown
            coefficient matrix.
            ...
            matrix $\overlapmat \in \mathbb{C}^{L \times L}$ reduces to the identity
            matrix.
            ...
            \end{gather}
            where $\fockmat \in \mathbb{C}^{L \times L}$ is the \emph{Fock
