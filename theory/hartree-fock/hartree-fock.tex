    ...
    \section{Solving the Hartree-Fock equations in a basis}
        ...
        \subsection{The unrestricted Hartree-Fock method}
            ...
            \begin{align}
                \phi_P(x)
                &=
                \varphi_{p\sigma}(\vf{r})
                \sigma(m_s)
                \implies
                \ket{\phi_P}
                = \ket{\varphi_{p\sigma}\sigma},
            \end{align}
            where $P \in \brac{1, \dots, L}$, $p \in \brac{1, \dots, L / 2}$,
            and $\sigma \in \brac{\alpha, \beta}$.
            Note that there is no implicit sum over the index $\sigma$ in the
            compound index $\varphi_{p\sigma}$ and the spin-function
            $\sigma(m_s)$.
            We can collect the orbitals in two sets
            $\brac{\ket{\varphi_{p\alpha}}_{p = 1}^{L / 2}}$ and
            $\brac{\ket{\varphi_{p\beta}}_{p = 1}^{L / 2}}$.
            ...
            \begin{align}
                ...
                =
                \ket{
                    (\varphi_{1\alpha}\alpha)
                    (\varphi_{1\beta}\beta)
                    \dots
                    (\varphi_{L/2\alpha}\alpha)
                    (\varphi_{L/2\beta}\beta)
                }.
            \end{align}
            ...
            \begin{align}
                ...
                &= \delta^{P}_{Q}
                = \braket{\sigma}{\tau}
                \braket{\varphi_{p\sigma}}{\varphi_{q\tau}}
                = \delta^{\sigma}_{\tau}
                S^{p\sigma}_{q\tau},
            \end{align}
            ...
            \begin{align}
                S^{p\sigma}_{q\sigma}
                \equiv
                \braket{\varphi_{p\sigma}}{\varphi_{q\sigma}}
                = \delta^{p}_{q}.
            \end{align}
            ...
            \begin{align}
                ...
                = \epsilon_P\ket{\phi_P}
                \implies
                \fock\ket{\varphi_{p\sigma}\sigma}
                = \epsilon_{p\sigma}\ket{\varphi_{p\sigma} \sigma},
            \end{align}
            which demonstrates how each spin-component yields a different
            equation as the Fock eigen energies $\epsilon_{p\alpha}$ is in
            general different from $\epsilon_{p\beta}$.
            By projecting onto another molecular orbital as in
            \autoref{eq:mo-fock-elements} we demonstrate how the spin decouples
            and yields two separate Fock matrices, one for each spin-direction.
            ...
            \end{align}
            where we again stress that the compound indices $p\sigma$ and
            $q\tau$ should not be summed with the spin-functions occuring in the
            Kronecker-Delta.
