\chapter{Quantum Mechanics}
    ...
    \section{Many-body operators in second quantization}
        ...
        Furthermore, we have re-instated explicit sums for the moment to avoid
        confusion.
    ...
    \section{Hermitian Lagrange multipliers}
        \label{app:hermitian-lagrange-multipliers}
        We prove that the Lagrange mutlipliers in \autoref{eq:hf-lagrangian} can
        be chosen Hermitian.
        \begin{proof}
    ...
    %        = \frac{1}{a^2}\para{\vfg{\nabla}'}^2,
    %    \end{align}
    %    where we have dropped the particle indices for the sake of brevity.
    ...
    %    \end{gather}
    %    where we have expressed the Laplace operator in polar coordinates.
    ...
    %    we have decoupled radial and the azimuthal dependence.
    ...
    %    In this section we will write out the closed form solution to the Coulomb
    ...
    %    \end{align}
    %    where we have again introduced the difference in the angular quantum
