...
energy = np.trace(np.dot(term, density_matrix))
    ...
    \section{Coupled cluster}
        ...
        \subsection{Convergence acceleration}
            The quasi-Newton method often suffers from convergence
            instabillities, especially for the case of quantum dots.
            % TODO: Back this up
            In order to alleviate some of these problems we introduce techniques
            which helps the method converge faster.
