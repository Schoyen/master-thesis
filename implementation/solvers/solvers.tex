...
energy = np.trace(np.dot(term, density_matrix))
    ...
    \section{Coupled cluster}
        ...
        \subsection{Convergence acceleration}
            ...
            The measurement is thus $\clustamp^{(i)}$.
            ...
            vectors, and in the case of more than one set of amplitudes we need
            to concatenate these vectors on top of one another.

            For the DIIS algorithm described in \autoref{subsec:diis} we define
            our error vectors to be
            \begin{align}
        ...
        \subsection{Non-orthogonal ground state solver}
            ...
            the NOCCD method can be formulated by:
            \begin{enumerate}
                \item Compute the orbital transformation matrices by
                    ...
                    \pyth{scipy.linalg.expm} from SciPy \cite{scipy}.
                ...
                \item Compute the stationary conditions for the orbital
                    ...
                    \autoref{eq:nocc-kappa-down-rhs}.
                    % TODO: How is kappa defined from these equations?
                    % TODO: More importantly, how do we get the D-matrix?
            \end{enumerate}
