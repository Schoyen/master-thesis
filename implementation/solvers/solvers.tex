...
density_matrix = C[:, o] @ C[:, 0].conj().T
            \end{python}
            where \pyth{n} is the number of occupied particles and \pyth{o} is a
...
rho_qp[o, o] = C[:, o].conj().T @ s @ C[:, o]
        ...
        \subsection{The restricted Hartree-Fock method}
            ...
            \end{align}
            where we have introduced the Coulomb operator from
            ...
            \end{align}
            where we have used the completeness relation for the spin of the
...
class AmplitudeContainer:
    ...
    def from_array(u, arr):
        ...
        \subsection{Time-dependent energy}
            ...
            \autoref{eq:cc-energy-functional}.
            We have listed the Lagrangian for CCD and CCSD in
            \autoref{app:cc-lagrangian}.
