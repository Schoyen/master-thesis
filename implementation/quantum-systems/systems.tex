    ...
    \section{Atomic and molecular systems}
        ...
        \begin{itemize}
            ...
            \item The split-valence ($X$-$YZ$g) basis sets \cite{x-yzg,
                helgaker-molecular}.
                Here $X$ denotes the number of primite Gaussian functions for
        ...
        along a specific axis, e.g., %TODO: Fill in molecule string example
        where \pyth{r} is a variable with the bond length in
        atomic units and we've specified the separation along the $z$-axis.
